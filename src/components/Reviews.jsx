    ...
    return (
        <div className="reviews">
            ...
            <div className="reviews-content">
                <p className="review-text">We take pride in delivering top-quality service and exceptional results. Here’s what some of our satisfied clients have shared about their experience with us.</p>
